        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="section-heading text-center">
                    ...
                    <h2 class="sec__title">Categorias</h2>
                    <p class="sec__desc">
                        Veja nossas lista de parceiros através das nossas categorias!
                    </p>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="section-heading text-center">
                    ...
                    <p class="sec__desc">
                        Locais escolhidos a dedo pela nossa equipe para que você possa <br>desfrutar dos melhores serviços disponíveis no BCSClub!
                    </p>
                </div><!-- end section-heading -->
            </div><!-- end col-lg-12 -->
        </div><!-- end row -->
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="section-heading text-center">
                    ...
                    <p class="sec__desc">
                        Encontrar um lugar para ficar nunca foi tão simples. <br> Veja abaixo como funciona o bcsclub!
                    </p>
                </div><!-- end section-heading -->
            </div><!-- end col-lg-12 -->
        </div><!-- end row -->
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="section-heading">
                    ...
                    <h2 class="sec__title">Sua empresa ou produto já está na Web?</h2>
                    <p class="sec__desc">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="section-heading">
                    ...
                    <p class="sec__desc">
                        Veja o que nossos clientes estão falando de nossos serviços!
                    </p>
                </div><!-- end section-heading -->
            </div><!-- end col-lg-12 -->
        </div><!-- end row -->
            ...
            <div class="col-lg-6">
                <div class="mobile-app-content">
                    <div class="section-heading">
                        ...
                        <h2 class="sec__title mb-3">Descubra lugares incríveis para onde quer que você for!</h2>
                        <p class="sec__desc font-size-17 margin-bottom-35px">
                            Veja aqui como utilizar o BCSClub.
                        </p>
                    </div><!-- end section-heading -->
                    <ul class="info-list contact-links">
                        ...
                        <li class="d-flex align-items-center mb-2"><i class="la la-bell icon"></i> Encontre tudo o que você precisa</li>
                    </ul>
