...
<div class="page-header">
    <h4 class="page-title">Todas as Consultas</h4>
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
        <li class="breadcrumb-item active" aria-current="page">Todas as consultas</li>
    </ol>
</div>
                                        ...
                                        <tr>
                                            ...
                                            <th class="">
                                                <?php if($item['status_marcado'] == 0):?>
                                                    <span class="text-orange">Não Marcado</span>
                                                <?php elseif($item['status_marcado'] == 1):?>
                                                    <span class="text-blue">Marcado para o dia <?php echo date('d/m/Y', strtotime($item['data_marcado'])).' às '.date('H:i', strtotime($item['data_marcado']));?></span>
                                                <?php elseif($item['status_marcado'] == 2):?>
                                                    <span class="text-green">Consulta Realizada!</span>
                                                <?php elseif($item['status_marcado'] == 3):?>
                                                    <span class="text-red">Consulta Cancelada</span>
                                                <?php endif;?>
                                            </th>
                                            <td>
                                                <?php if($item['status_marcado'] != 3):?>
