            ...
            <div class="col-lg-12">
                <div class="breadcrumb-content d-flex flex-wrap align-items-center justify-content-between">
                    <div class="section-heading">
                        <h2 class="sec__title text-white font-size-40 mb-0">Fale Conosco</h2>
                    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 responsive-column">
                <div class="info-box info--box">
                    <div class="info-icon gradient-icon">
                        <svg width="40"  version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 512.076 512.076" xml:space="preserve">
                           <defs>
            ...
            <div class="col-lg-4 responsive-column">
                <div class="info-box info--box">
                    <div class="info-icon gradient-icon">
                        <svg  width="40" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 512 512" xml:space="preserve">
                            <defs>
                    ...
                    <div class="info-content">
                        <h4 class="info__title mb-2">Envie-nos um E-mail</h4>
                        <p class="info__desc"><a href="" class="btn-text">contato@bcsclub.com</a></p>
                    </div><!-- end info-content -->
                </div><!-- end info-box -->
            </div><!-- end col-lg-4 -->
            <div class="col-lg-4 responsive-column">
                <div class="info-box info--box">
                    <div class="info-icon gradient-icon">
                        <svg width="40" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 480 480" xml:space="preserve">
                            <defs>
            ...
            <div class="col-lg-8">
                <div class="block-card">
                    <div class="block-card-header">
                        <h3 class="widget-title pb-0">Envie-nos uma mensagem</h3>
                        <p class="pt-1">Diga em que podemos te ajudar! Escreva detalhadamente a sua duvida para podermos te ajudar!</p>
                    </div><!-- block-card-header -->
                    <div class="block-card-body">
                        <form method="post" class="form-box row">
                            <div class="col-lg-6">
                                <div class="input-box">
                                    <label class="label-text">Seu nome</label>
                            ...
                            <div class="col-lg-6">
                                <div class="input-box">
                                    <label class="label-text">Seu Email</label>
                                    <div class="form-group">
                            ...
                            <div class="col-lg-12">
                                <div class="input-box">
                                    <label class="label-text">Seu Telefone</label>
                                    <div class="form-group">
                                        <span class="la la-phone form-icon"></span>
                                        <input class="form-control form-control-styled" type="text" name="phone" placeholder="Telefone">
                                    </div>
                                </div>
                            </div><!-- end col-lg-6 -->
                            <!-- <div class="col-lg-12">
                                <div class="input-box">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control form-control-styled" type="text" name="msg" placeholder="Subject">
                                    </div>
                                </div>
                            </div><!-- end col-lg-12 -->
                            <div class="col-lg-12">
                                <div class="input-box">
                                    <label class="label-text">Sua Mensagem</label>
                                    <div class="form-group">
                                        <span class="la la-pencil form-icon"></span>
                                        <textarea class="message-control form-control" name="msg" placeholder="Escreva sua mensagem"></textarea>
                                    </div>
                                </div>
                            </div><!-- end col-lg-12 -->
                            <div class="col-lg-12">
                                <div class="btn-box">
                                    <button type="submit" class="theme-btn gradient-btn border-0">Enviar Mensagem <i class="la la-arrow-right ml-1"></i></button>
                                    <p class="font-size-14 pt-1">Nós lhe retornaremos assim que possível!</p>
                                </div>
                            </div><!-- end col-lg-12 -->
                        </form>
                ...
                <div class="block-card">
                    ...
                    <div class="block-card-body">
                        ...
                        <ul class="list-items pb-4">
                            ...
                            <li class="d-flex align-items-center justify-content-between"><span>Domingo</span> <span class="text-color-2">Fechado</span></li>
                        </ul>
