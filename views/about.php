            ...
            <div class="col-lg-12">
                <div class="breadcrumb-content">
                    <div class="section-heading">
                        <h2 class="sec__title text-white font-size-40 line-height-55">Sobre nós</h2>
                    </div>
                    <!-- <a class="btn-gray hover-scale mt-1" href="https://www.youtube.com/watch?v=GlrxcuEDyF8" data-fancybox="">
                        <span class="la la-youtube-play mr-2"></span>Assista ao video
                    </a> -->
...
<section class="about-area padding-bottom-100px">
    <div class="container">
        ...
        <div class="section-block"></div>
        <div class="row padding-top-90px">
...
<!-- ================================
    START FUN-FACT AREA
================================= -->
<section class="funfact-area bg-gradient-gray section--padding">
    <div class="container">
        <div class="row">
    ...
    <div class="container">
        ...
        <div class="row padding-top-60px">
            <div class="col-lg-4 responsive-column">
                <div class="info-box info--box js-tilt-2">
                    <div class="info-icon gradient-icon">
                        <svg width="40" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 505.4 505.4" xml:space="preserve">
                            <defs>
            ...
            <div class="col-lg-4 responsive-column">
                <div class="info-box info--box js-tilt-2">
                    <div class="info-icon gradient-icon">
                        <svg width="40" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 496 496" xml:space="preserve">
                              <defs>
