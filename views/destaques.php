...
================================= -->
<section class="breadcrumb-area bread-bg  overflow-hidden" style="background-position: <?php echo $dadosCategory['back_pos'];?>; background-image: url('<?php echo BASE_URL."assets/blog/images/banner-categorias.png";?>');">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="breadcrumb-content d-flex flex-wrap align-items-center justify-content-between">
                    <div class="section-heading">
                        <h2 class="sec__title text-white font-size-40 mb-0">Comerciantes em destaque</h2>
                    </div>
                    <ul class="list-items bread-list">
                        <li><a href="<?php echo BASE_URL;?>">Home</a></li>
                        <li><a href="<?php echo BASE_URL.'pages/categories'?>">Comércios</a></li>
                        <li>Destaques</li>
                    </ul>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="filter-bar d-flex flex-wrap justify-content-between align-items-center margin-bottom-30px">
                    <p class="result-text font-weight-medium">Exibindo tantos de tantos </p>
            ...
            <?php 
                foreach($listPostFeaturedWPagination as $item){
                    ...
                    <div class="col-lg-12 pt-3 text-center">
                        <div class="pagination-wrapper d-inline-block">
                            <div class="section-pagination">
                                <nav aria-label="Page navigation">
                                    <ul class="pagination flex-wrap justify-content-center">
                                        <li class="page-item">
                                            <?php if($_GET['p'] > 1):?>
                                                <a class="page-link" href="<?php echo BASE_URL.'/destaques?p='.$_GET['p']-1;?>" aria-label="Anterior">
                                        ...
                                        <?php for($q=1;$q<=$p;$q++):?>
                                            <li class="page-item"><a class="page-link <?php echo ($_GET['p'] == $q )?'page-link-active':'';?> " href="<?php echo BASE_URL.'destaques?p='.$q;?>"><?php echo $q;?></a></li>
                                        <?php endfor;?>
                                        ...
                                        <li class="page-item">
                                            <?php if($_GET['p'] < $p):?>
                                                <a class="page-link" href="<?php echo BASE_URL.'destaques?p='.$_GET['p']+1?>" aria-label="Next">
                            ...
                            <!-- <ul class="pagination-simple d-flex align-items-center justify-content-center pt-3">
                                <li class="mr-4">
                                    <a href="#" class="pagination-simple-nav first-nav"><i class="la la-long-arrow-left mr-1"></i>Pri</a>
                                </li>
                                <li>
                    ...
                    <div class="sidebar-widget">
                        ...
                        <form method="POST" class="form-box" action="<?php echo BASE_URL."search";?>">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="search" placeholder="O que você procura?">
                            </div>
